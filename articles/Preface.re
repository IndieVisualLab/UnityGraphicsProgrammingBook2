...
本書はUnityによるグラフィクスプログラミングに関する技術を解説する「Unityグラフィックスプログラミング」シリーズの第二巻です。
本シリーズでは、執筆者たちの興味の赴くままに取り上げられた様々なトピックについて、初心者向けの入門的な内容と応用を解説したり、中級者以上向けのtipsを掲載しています。

各章で解説されているソースコードについてはgithubリポジトリ（@<href>{https://github.com/IndieVisualLab/UnityGraphicsProgramming2,https://github.com/IndieVisualLab/UnityGraphicsProgramming2}）にて公開していますので、手元で実行しながら本書を読み進めることができます。
...
//image[web_form_qr_code][WebフォームQRコード][scale=0.5]
